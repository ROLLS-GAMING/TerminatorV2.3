...
\033[35m                ╔═══════════════════════════════════════════════╗
\033[35m                ║\033[32m- - - - - - - Terminator vF By \033[36m@Eclipse \033[35m- - - - - - -║
...
#kaltebg tembus	23100,32100
	while True:
		...
		sys.stdout.write("\x1b]2;Terminator. | Devices: [{}] | Spoofed Servers [1] | Server Units [8] | Clients: [18]\x07".format (bots))
		sin = input("\033[32m[\033[35m{}\033[32m@Terminator]\033[36m$ \033[96m".format(nicknm)).lower()
		sinput = sin.split(" ")[0]
		if sinput == "clear":
			os.system ("clear")
			print (banner)
